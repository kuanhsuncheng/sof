...
const struct xthal_MPU_entry __xt_mpu_init_table[] __attribute__((section(".ResetVector.text"))) = {
    ...
    XTHAL_MPU_ENTRY(0x50000000, 1, XTHAL_AR_RWXrwx, XTHAL_MEM_WRITEBACK), // dram
    XTHAL_MPU_ENTRY(0x50500000, 1, XTHAL_AR_RWXrwx, XTHAL_MEM_NON_CACHEABLE), // dram
    XTHAL_MPU_ENTRY(0x60000000, 1, XTHAL_AR_NONE, XTHAL_MEM_DEVICE), // unused
};
