...
#define ADSPPLL_CON0           (MTK_REG_APMIXDSYS_BASE + 0x304)
#define ADSPPLL_CON1           (MTK_REG_APMIXDSYS_BASE + 0x308)
#define ADSPPLL_CON2           (MTK_REG_APMIXDSYS_BASE + 0x30C)
#define ADSPPLL_CON3           (MTK_REG_APMIXDSYS_BASE + 0x310)

#define CLK_MODE               (MTK_REG_TOPCKGEN_BASE + 0x0)
#define CLK_CFG_UPDATE1        (MTK_REG_TOPCKGEN_BASE + 0x8)
#define CLK_CFG_11             (MTK_REG_TOPCKGEN_BASE + 0x0EC)
#define CLK_CFG_11_SET         (MTK_REG_TOPCKGEN_BASE + 0x0F0)
#define CLK_CFG_11_CLR         (MTK_REG_TOPCKGEN_BASE + 0x0F4)
#define CLK_CFG_15             (MTK_REG_TOPCKGEN_BASE + 0x180)
#define CLK_CFG_15_SET         (MTK_REG_TOPCKGEN_BASE + 0x184)
#define CLK_CFG_15_CLR         (MTK_REG_TOPCKGEN_BASE + 0x188)
...
#define MTK_DSP_MBOX_IN_CMD(x) (MTK_DSP_MBOX_REG_BASE(x) + 0x100)
#define MTK_DSP_MBOX_IN_CMD_CLR(x) (MTK_DSP_MBOX_REG_BASE(x) + 0x108)
#define MTK_DSP_MBOX_OUT_CMD(x) (MTK_DSP_MBOX_REG_BASE(x) + 0x104)
#define MTK_DSP_MBOX_OUT_CMD_CLR(x) (MTK_DSP_MBOX_REG_BASE(x) + 0x10c)
