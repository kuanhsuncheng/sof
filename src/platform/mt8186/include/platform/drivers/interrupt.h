...
#define LX_MBOX_IRQ0_B (INT_LEVEL(MTK_DSP_INT_MAILBOX) | INTERRUPT_ID(26))
#define LX_MBOX_IRQ1_B (INT_LEVEL(MTK_DSP_INT_MAILBOX) | INTERRUPT_ID(27))
#define LX_MBOX_IRQ2_B (INT_LEVEL(MTK_DSP_INT_MAILBOX) | INTERRUPT_ID(28))
#define LX_MBOX_IRQ3_B (INT_LEVEL(MTK_DSP_INT_MAILBOX) | INTERRUPT_ID(29))
#define LX_MBOX_IRQ4_B (INT_LEVEL(MTK_DSP_INT_MAILBOX) | INTERRUPT_ID(30))
