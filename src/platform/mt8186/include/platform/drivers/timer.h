...
#define TIMER_CON(n) (MTK_DSP_OS_TIMER_BASE + 0x0 + 0x10 * (n))
#define TIMER_RST_VAL(n) (MTK_DSP_OS_TIMER_BASE + 0x4 + 0x10 * (n))
#define TIMER_CUR_VAL(n) (MTK_DSP_OS_TIMER_BASE + 0x8 + 0x10 * (n))
#define TIMER_IRQ_ACK(n) (MTK_DSP_OS_TIMER_BASE + 0xC + 0x10 * (n))
...
#define OSTIMER_CON (MTK_DSP_OS_TIMER_BASE + 0x80)
#define OSTIMER_INIT_L (MTK_DSP_OS_TIMER_BASE + 0x84)
#define OSTIMER_INIT_H (MTK_DSP_OS_TIMER_BASE + 0x88)
#define OSTIMER_CUR_L (MTK_DSP_OS_TIMER_BASE + 0x8C)
#define OSTIMER_CUR_H (MTK_DSP_OS_TIMER_BASE + 0x90)
#define OSTIMER_TVAL (MTK_DSP_OS_TIMER_BASE + 0x94)
#define OSTIMER_IRQ_ACK (MTK_DSP_OS_TIMER_BASE + 0x98)
